...
export function Search() {
    ...
    <button className="navbar-tool" onClick={()=>history.back()}>
        <ChevronLeftIcon className='h-6 w-6' /> </button>


    <input id="s1"
        className=' bg-transparent focus:outline-none text-sm'
     autoFocus type="text" placeholder="Search for service" onInput={search}/>


    <div className="navbar-right">
        <button aria-label="edit" className="navbar-tool"  onClick={()=>clearSearch()}><XMarkIcon className='h-6 w-6' /></button>
    </div>
    ...
    <div className="fileList">
        ...
        <a className="card" href="#">
            <div className="fl-title"><span>asdf</span></div>
            <div className="fl-subtitle"><span>asfdsd</span></div>
        </a>
