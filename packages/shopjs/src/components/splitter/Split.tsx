...
// jkh change to trick pixels; we don't want the 
          ...
          <div className={rootClassName} style={rootStyle}>
            ...
            >
              <Measure bounds onResize={onMeasureSplitter}>
                {({ measureRef: splitterRef }:{measureRef: any}) => (
